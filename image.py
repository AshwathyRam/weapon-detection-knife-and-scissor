...
# Load YOLOv3
net = cv2.dnn.readNet("C:/Users/saraswathy/Downloads/New folder/coco.cfg", "C:/Users/saraswathy/Downloads/New folder/coco.weights")
# Load classes
with open("C:/Users/saraswathy/Downloads/New folder/labels.txt", "r") as f:
...
# Load image
img = cv2.imread("C:/Users/saraswathy/Downloads/New folder/download.jpeg")
