...
net = cv2.dnn.readNetFromDarknet('C:/Users/saraswathy/Downloads/New folder/coco.cfg', 'C:/Users/saraswathy/Downloads/New folder/coco.weights')
classes = []
with open('C:/Users/saraswathy/Downloads/New folder/labels (1).txt', 'r') as f:
...
while True:
    ...
    blob = cv2.dnn.blobFromImage(frame, 0.0032, (416, 416), (0, 0, 0), True, crop=False)
    net.setInput(blob)
